                                                            ...
                                                            children:[Positioned.fill(
                                                                child: Align(
                                                                    ...
                                                                    child: Container(
                                                                        ...
                                                                        padding: const EdgeInsets.only(left: 48, right: 125, top: 26, bottom: 165, ),
                                                                        child: Stack(
                                                                            children: [
                                                                                Positioned.fill(
                                                                                    child: Row(
                                                                                        ...
                                                                                        children:[
                                                                                            Container(
                                                                                                ...
                                                                                                child: FlutterLogo(size: 115.23854064941406),
                                                                                            ),
                                                                                        ],
                                                                                    ),
                                                                                ),
                                                                                Positioned.fill(
                                                                                    child: FlutterLogo(size: 305.884521484375),
                                                                                ),
                                                                            ],
                                                                        ),
                                                                    ),
                                                            ...
                                                            Positioned.fill(
                                                                child: Align(
                                                                    ...
                                                                    child: Container(
                                                                        ...
                                                                        child: FlutterLogo(size: 113.22999572753906),
                                                                    ),
                                                                ),
                                                            ),
                                                            Positioned(
                                                                ...
                                                                child: Container(
                                                                    ...
                                                                    padding: const EdgeInsets.only(left: 82, right: 76, top: 14, bottom: 9, ),
                                                                    child: Stack(
                                                                        children: [
                                                                            Positioned.fill(
                                                                                child: Row(
                                                                                    ...
                                                                                    children:[
                                                                                        Container(
                                                                                            ...
                                                                                            child: FlutterLogo(size: 79.78414916992188),
                                                                                        ),
                                                                                    ],
                                                                                ),
                                                                            ),
                                                                            Positioned.fill(
                                                                                child: FlutterLogo(size: 167.89036560058594),
                                                                            ),
                                                                        ],
                                                                    ),
                                                                ),
